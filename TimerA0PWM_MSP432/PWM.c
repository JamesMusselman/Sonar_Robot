...
if(duty1 >= period) return; // bad input
  ...
  TA1CCTL0 = 0x0080;      // CCI0 toggle
  TA1CCR0 = period;       // Period is 2*period*8*83.33ns is 1.333*period
  TA1EX0 = 0x0000;        //    divide by 1
  TA1CCTL1 = 0x0040;      // CCR1 toggle/reset
  TA1CCR1 = duty1;        // CCR1 duty cycle is duty1/period
  TA1CCTL2 = 0x0040;      // CCR2 toggle/reset
  TA1CCR2 = duty2;        // CCR2 duty cycle is duty2/period
  TA1CTL = 0x02F0;        // SMCLK=12MHz, divide by 8, up-down mode
	*/
}
//***************************PWM_Duty1*******************************
