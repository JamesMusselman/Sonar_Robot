...
SysTick_Init
	...
	MOV  R4, R0	                    ; Move period from R0 into R4
	SUBS R4, #1                     ; Subtract 1 from period
    ...
    LDR  R1, =SYSTICK_STCSR         ; R1 = &SYSTICK_STCSR (pointer)
    MOV  R0, #0x00000007            ; R0 = ENABLE and CLKSOURCE bits set; TICKINT bit Set
    STR  R0, [R1]
